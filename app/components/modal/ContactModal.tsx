    ...
    return (
        <div className={styles.modal}>
            <div className={styles.left}>
                ...
                <div className={styles.close} onClick={close}>Lukk X</div>
                ...
                <ul className={styles["bottom-links"]}>
                    <li><a onClick={() => { console.log("Link clicked") }}>Personvernerklæring</a></li>
                    <li><a onClick={() => { console.log("Link clicked") }}>Cookies</a></li>
                </ul>
            ...
            <div className={styles.right}>
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1788.477022556059!2d10.370156215718598!3d63.367880887906594!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x466d2f49ac1a4a63%3A0x74c2dd51b4a4a12a!2sNano%20Detailing%20AS!5e0!3m2!1sen!2sno!4v1681298396636!5m2!1sen!2sno&zoom=10" width="100%" height="100%" loading="lazy" referrerPolicy="no-referrer-when-downgrade" ></iframe>
            </div>
        </div>
    )
}
