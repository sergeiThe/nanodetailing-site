...
export const services = [
    {
        ...
        content: {
            ...
            p2: "Behandlingens varighet er lengre enn for syntetisk lakkforsegling. Lakkforsegling passer for deg som ønsker en lettere bilvedlikehold og dramatisk lavere bilens verditap.",
            ...
            p5: "Når det er på tide å vaske kjøretøyet ditt, vil du finne at tiden det tar å ta vare på vaske- og prøveprosessen er halvert, og som en ekstra bonus ser bilen nylakkert ut hver gang du er ferdig!",
            p6: "Selv om ingen belegg er ripesikkert, gir et keramisk belegg sterk beskyttelse mot mindre riper og virvler som påvirker det generelle utseendet til malingen din. Dette holder bilen eller lastebilen din flott i veldig lang tid.",
        },
        image: "tesla1.png",
    },
    {
        ...
        content: {
            ...
            p2: "Har du en leasingbil, er denne servicen et nødvendig tiltak mot store regninger på lakkskader. Hvis du eier bilen self og er interessert i å bevare bilen i en lang periode, er PPF et fantastisk valg.",
    ...
    },
    {
        ...
        content: {
            ...
            p2: "- Holder bilen kjølig og lindrer ditt klimaanlegg",
    ...
    },
    {
        name: "Helfoliering",
        content: {
            p1: "Det er stor utvalg av farger. Mulighetene er det massevis av. For eksempel kan man kun helfoliere halvparten av bilen, kun helfoliere taket eller foliere hele kjøretøyet.",
...
for (const v of services) {
    servicesMap.set(v.name, v.content);
}
