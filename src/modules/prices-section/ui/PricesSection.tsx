  ...
  return (
    ...
    >
      ...
      <div className="text-white">
        <div className="">
          <h2 className="text-slate-200 text-5xl text-center">Faste priser</h2>
          <p className="text-slate-100 max-w-[700px] text-center mx-auto py-6">
            Vi har faste priser for enkelte bilmerker. Er ikke bilen din på
            lista, ta kontakt med oss!
          </p>
